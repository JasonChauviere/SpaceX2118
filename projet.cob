        ...
        NOT INVALID KEY
            ...
            START Fastronautes , KEY IS = fa_idEquipe
                INVALID KEY
                    DISPLAY "erreur"
                NOT INVALID KEY
                    PERFORM WITH TEST AFTER UNTIL Wfin = 1 OR fa_idEquipe <> fe_idEquipe
                        READ Fastronautes
                            AT END
                                MOVE 1 TO WFin
                            NOT AT END
                ...
                NOT INVALID KEY
                    ...
                    START Fvaisseaux  KEY IS = fv_nomLieu
                        INVALID KEY
                            DISPLAY "erreur"
                        NOT INVALID KEY
                            PERFORM WITH TEST AFTER UNTIL Wfin = 1 OR fv_nomLieu <> fm_nomLieu
                                READ Fvaisseaux
                                    AT END
                                        MOVE 1 TO Wfin
                                    NOT AT END
                                        IF WnbEquipe < fv_capacite THEN
                                            MOVE fv_capacite  TO WnbEquipe
                                            MOVE fv_nomVaisseau TO WnomVaisseau
                                        END-IF
                                END-READ
                            END-PERFORM
        ...
        NOT INVALID KEY
            ...
            READ Fmissions
                INVALID KEY
                    DISPLAY "erreur"
                NOT INVALID KEY
                    DISPLAY "le lieu de la mission  : " fm_nomLieu
            END-READ
    END-READ
