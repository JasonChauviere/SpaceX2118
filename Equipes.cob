       AJOUT_EQUIPE.
               ...
               READ Fequipes  KEY IS fe_idEquipe
                   INVALID KEY
                        DISPLAY "identifiant du commandant"
                        ACCEPT fa_idAstronaute
                        READ Fastronautes
                            INVALID KEY
                               DISPLAY "commandant existe pas"
                            NOT INVALID KEY
                               ...
                               ELSE
                                   DISPLAY "le commandant possède deja".
                                           ."une équipe"
                               END-IF

                    NOT INVALID KEY
                    DISPLAY "identifiant d'equipe existe deja"
               END-READ
               ...
               READ Fequipes  KEY IS fe_idEquipe
                   ...
                   NOT INVALID KEY
                       START Fastronautes
                           INVALID KEY
                               DISPLAY "pas d'astronaute"
                           NOT INVALID KEY
                               PERFORM WITH TEST AFTER UNTIL Wfin = 1
                                       OR fa_equipe <> fe_idEquipe
                ...
                NOT INVALID KEY
                    ...
                    START Fastronautes , KEY IS = fa_idEquipe
                        INVALID KEY
                            DISPLAY "erreur"
                        NOT INVALID KEY
                            PERFORM WITH TEST AFTER UNTIL Wfin = 1 OR
                               fa_idEquipe <> fe_idEquipe
                                READ Fastronautes
                                    AT END
                                        MOVE 1 TO WFin
                                    NOT AT END
                        ...
                        READ Fmissions , KEY IS  fm_idMission
                            ...
                            NOT INVALID KEY
                                IF fm_nomLieu = WnomLieu THEN
                                    DISPLAY "identidiant : " fm_idMission
                                    DISPLAY "description : " fm_description
                                END-IF
                        END-READ
                END-READ
            END-PERFORM
